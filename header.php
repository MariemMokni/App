...
include("includes/classes/Post.php");
   ...
   if(isset($_SESSION['username'])){
		 ...
		 $user = mysqli_fetch_array($user_details_query); //etudiant
		 $user2 = mysqli_fetch_array($user_details_query2); //prof
   }
   else{
...
<body>
  ...
  <div class="background"></div>
	<div class="top_bar">
		<div class="logo">
			<a href="index.php" style="text-decoration: none">Systeme E-Learning</a>
		</div>
             <div class="icon">
					<nav>
						<?php 
					...
					<a href="createJoinClass.php"><i class="fas fa-plus"></i>
							<span class="tooltiptext">Creer or rejoindre Classe</span>
							</a>
