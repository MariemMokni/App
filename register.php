...
<body>
    ...
    <div class="wrapper">
        <div class="landing">
            <h1 class="brand">Systeme E - Learning </h1>
        ...
        <div class="login_box">
            ...
            <div id="first">
                <form action="register.php" method="POST" id="login-form">
                    ...
                    <br>
                    <a href="#" id="signup" class="signup">Besoin d'un compte ? S'inscrire ici</a>
            ...
            <div id="second">
                <form action="register.php" method="POST" id="register-form">
                    <input type="text" name="reg_fname" placeholder="Prenom" value="<?php 
                    ...
                    <br>
                    <input type="password" name="reg_password2" placeholder="Confirmer password" required>
                    <br>

                    <?php if (in_array("Your password do not match<br>", $error_array)) echo "pasword ne correspondent pas <br>"; ?>
                    ...
                    <a href="#" id="signin" class="signin">Vous avez déjà un compte ? S'identifier</a>
    ...
    <script>
        ...
        $("#signup").click(function()  {
            ...
            //on click signup, hide registertion form and show login form
