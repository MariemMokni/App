...
<div class=Wrapper2>
    ...
    <div class="user_details cloumn">
        ...
        <p style='line-height:30px; display: inline-block;'><b>Section:</b> <?php echo $sec ?>
            <br>
            <b>Code de la classe:</b> <?php echo $classCode ?><span id="code_expand"><i class="fas fa-expand-arrows-alt"></i></span>
        </p>
        ...
        <div class="assignment_box">
            ...
            <a href="#" id="assignmentBtn"><i class="far fa-file-word" style='margin-right: 5px;'></i>Section d'assignation</a>
    ...
    <div class="people_column">
       <h4>Instructeur :</h4><a href="<?php echo $teacherName; ?>"><img src='<?php echo $teacherDetails['profilePic'] ?>' width='40'><?php echo $teacherDetails['first_name'] . " " . $teacherDetails['last_name'] ?></a>
        <br>
        <!-- <?php echo "Posts: " . $user_array['num_posts'] . "<br>"; ?> -->
        <!-- <?php 
        $stundentsName  = new User($con, $classCode ,$userLoggedIn);
        echo "<p><b>Membres de la classe : </b></p>"; ?>
    ...
    <div class="main_column">
        <div id="first">
            <form class="post_form" method="POST">
                <textarea name='post_text' id='post_text_area' placeholder='Partagez quelque chose...'></textarea>
        ...
        <div id="second">
            <form class="assignment_form" method="POST" enctype="multipart/form-data">
                ...
                <textarea name='assignment_text' id='assignment-textarea' placeholder='Tapez ici'></textarea>
